...
def get_monthly_component(month:str, title:str):
    ...
    with overview:
        overview = pd.read_json(f"./data/{month}/frigate_overview.json")
    ...
    with tab1:
        frigate_attacker_rank = pd.read_json(f"./data/{month}/frigate_attacker_rank.json")

        final = frigate_attacker_rank.style.set_properties(**coloring).set_table_styles([headers])
        ...
        attacker_weapon_rank =  pd.read_json(f"./data/{month}/frigate_attacker_weapon_rank.json")
    ...
    with tab2:
        victim_rank = pd.read_json(f"./data/{month}/frigate_victim_rank.json")
    ...
    with tab3:
        system_rank = pd.read_json(f"./data/{month}/frigate_system_rank.json")
    ...
    with tab4:
        ...
        attacker_faction_rank = pd.read_json(f"./data/{month}/frigate_attacker_faction_rank.json")
        ...
        victim_faction_rank = pd.read_json(f"./data/{month}/frigate_victim_faction_rank.json")
